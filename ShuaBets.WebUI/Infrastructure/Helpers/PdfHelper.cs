...
namespace ShuaBets.WebUI.Infrastructure.Helpers
{
    ...
    public class PdfHelper
    {
        ...
        //    try {
        //        string docName = String.Format(@"ShuaBets_Sales_{0}.pdf", UgandaDateTime.DateNow().Date.ToString("ddMMMyyyy"));
        //        docName = FileService.RemoveIllegalCharacters(docName, true);

        //        string destinationFolder = @"~/App_Data";

        //        //string logo = HttpContext.Current.Server.MapPath("~/Content/Imgs/ShuaBets_logo.png");
        ...
        //        doc.Add(ParsePageHeading("ShuaBets Periodical Sales Report"));
